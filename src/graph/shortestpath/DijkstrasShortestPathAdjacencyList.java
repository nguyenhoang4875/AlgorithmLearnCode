...
public class DijkstrasShortestPathAdjacencyList {
    ...
    public static void main(String[] args) {
        DijkstrasShortestPathAdjacencyList m = new DijkstrasShortestPathAdjacencyList(6);
        m.n = 6;
        m.createEmptyGraph();
        m.addEdge(0, 1, 5);
        m.addEdge(0, 2, 1);
        ...
        m.addEdge(3, 5, 6);
        m.addEdge(4, 5, 1);
        double result = m.dijkstra(0, 5);
        System.out.println(result);
        List<Integer> path = m.reconstructPath(0, 5);
        System.out.println("Path from start to end:");
        System.out.println(Arrays.toString(path.toArray()));
        System.out.println("prev");
        System.out.println(Arrays.toString(m.prev));
    }
